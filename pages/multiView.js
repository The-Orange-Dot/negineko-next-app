    ...
    return (
      <div key={streamer} className={styles.streamerContainer}>
        <div className={styles.videoFeed}>
          ...
          <iframe
            src={`https://player.twitch.tv/?channel=${streamer}&parent=negineko-site.herokuapp.com&muted=true`}
            height="380"
            width="675"
          ...
          ></iframe>
          <iframe
            src={`https://www.twitch.tv/embed/${streamer}/chat?parent=negineko-site.herokuapp.com`}
            height="400"
            width="675"
            className={styles.iframe}
          ></iframe>
